...
const TestDetail = () => {
  ...
  const handleStripePayment = async () => {
    ...
    await stripe?.redirectToCheckout({
      ...
      mode: "payment",
      successUrl: `https://toxscreenlabs.com/tests/${params.id}`,
      cancelUrl: `https://toxscreenlabs.com/tests/${params.id}`,
    });
  };
  return (
    <div className=" w-[85%]  mx-auto mt-12 md:mt-24 mb-64 flex flex-col gap-28 ">
